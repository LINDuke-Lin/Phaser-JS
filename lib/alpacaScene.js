...
class alpacaScene extends Phaser.Scene {
  ...
  preload() {
    ...
    //載入技能
    this.load.image("file1", "./assets/skills/fire/file-1.png");
    this.load.image("file2", "./assets/skills/fire/file-2.png");
    this.load.image("file3", "./assets/skills/fire/file-3.png");
    this.load.image("file4", "./assets/skills/fire/file-4.png");
    this.load.image("file5", "./assets/skills/fire/file-5.png");
    this.load.image("file6", "./assets/skills/fire/file-6.png");
    this.load.image("file7", "./assets/skills/fire/file-7.png");
    this.load.image("file8", "./assets/skills/fire/file-8.png");
  }
